...
// Source: github.com/ContinuumLLC/platform-common-lib/src/namedpipes (interfaces: ServerPipe,ClientPipe)

package mock

import (
	namedpipes "github.com/ContinuumLLC/platform-common-lib/src/namedpipes"
