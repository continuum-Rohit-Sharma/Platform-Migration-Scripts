...
// Source: github.com/ContinuumLLC/platform-common-lib/src/config (interfaces: ConfigurationService)

package mock

import (
	config "github.com/ContinuumLLC/platform-common-lib/src/config"
